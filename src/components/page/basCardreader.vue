    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-select v-model="query.address2" placeholder="设备规格" class="handle-select mr10">
                    <el-option key="1" label="" value=""></el-option>
                    <el-option key="2" label="0001" value="0001"></el-option>
                    <el-option key="3" label="0002" value="0002"></el-option>
                    <el-option key="4" label="0003" value="0003"></el-option>
                </el-select>
            ...
            >
                ...
                <el-table-column prop="readerspeed" label="读卡速度"></el-table-column>
                <el-table-column prop="timeinterval" label="打卡间隔"></el-table-column>
                <el-table-column prop="distance" label="感应距离"></el-table-column>
                <el-table-column prop="readertype" label="读卡类型"></el-table-column>
                <el-table-column prop="frequency" label="读卡频率"></el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="95px">
                ...
                <el-form-item label="设备类型"><el-input v-model="form.type"></el-input></el-select></el-form-item>
                <el-form-item label="设备规格Id"><el-input v-model="form.spec"></el-input></el-form-item>
                ...
                <el-form-item label="读卡速度"><el-input v-model="form.readerspeed"></el-input></el-form-item>
                <el-form-item label="打卡间隔"><el-input v-model="form.timeinterval"></el-input></el-form-item>
                <el-form-item label="感应距离"><el-input v-model="form.distance"></el-input></el-form-item>
                <el-form-item label="读卡类型"><el-input v-model="form.readertype"></el-input></el-form-item>
                <el-form-item label="读卡频率"><el-input v-model="form.frequency"></el-input></el-form-item>
        ...
        <el-dialog title="添加" :visible.sync="addVisible" width="30%">
            <el-form ref="form" :model="form" label-width="95px">
                ...
                <el-form-item label="打卡间隔"><el-input v-model="form.timeInterval"></el-input></el-form-item>
                <el-form-item label="感应距离"><el-input v-model="form.distance"></el-input></el-form-item>
                <el-form-item label="读卡类型"><el-input v-model="form.readtype"></el-input></el-form-item>
                <el-form-item label="读卡频率"><el-input v-model="form.frequency"></el-input></el-form-item>
                <el-form-item label="供应商"><el-input v-model="form.supplier"></el-input></el-form-item>
                <el-form-item label="生产商"><el-input v-model="form.manufacturer"></el-input></el-form-item>
                <el-form-item label="出厂编号"><el-input v-model="form.factorynumber"></el-input></el-form-item>
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                this.$axios.get('/api/basCardreader/selectAll').then(res =>{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.$axios.get('/api/basCardreader/delete?id='+row.id).then(res=>{
            ...
            saveEdit() {
                ...
                this.$axios.post('/api/basCardreader/edit',this.form).then(res=>{
            ...
            saveAdd() {
                ...
                this.$axios.post('/api/basCardreader/add',this.form).then(res=>{
            ...
            // 触发搜索按钮
            handleSearch() {
                this.$axios.get('/api/basCardreader/select?type='+this.query.address1+'&spec='+this.query.address2+'&id='+this.query.code).then(res =>{
                    this.tableData = res.data;
                    this.toString();
                })
