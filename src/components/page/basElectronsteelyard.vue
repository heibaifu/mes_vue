    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="esname" label="名称"></el-table-column>
                <el-table-column prop="esrange" label="称量范围"></el-table-column>
                <el-table-column prop="esweight" label="重量"></el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="95px">
                <el-form-item label="设备编码"><el-input v-model="form.id"></el-input></el-form-item>
                <el-form-item label="设备条码"><el-input v-model="form.qrcode"></el-input></el-form-item>
                <el-form-item label="设备类型"><el-input v-model="form.type"></el-input></el-form-item>
                ...
                <el-form-item label="名称"><el-input v-model="form.esname"></el-input></el-form-item>
                <el-form-item label="称量范围"><el-input v-model="form.esrange"></el-input></el-form-item>
                <el-form-item label="重量"><el-input v-model="form.esweight"></el-input></el-form-item>
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                this.$axios.get('/api/basElectronsteelyard/selectAll').then(res =>{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.$axios.get('/api/basElectronsteelyard/delete?id='+row.id).then(res=>{
            ...
            saveEdit() {
                ...
                this.$axios.post('/api/basElectronsteelyard/edit',this.form).then(res=>{
            ...
            saveAdd() {
                ...
                this.$axios.post('/api/basElectronsteelyard/add',this.form).then(res=>{
            ...
            // 触发搜索按钮
            handleSearch() {
                this.$axios.get('/api/basElectronsteelyard/select?type='+this.query.address1+'&spec='+this.query.address2+'&id='+this.query.code).then(res =>{
                    this.tableData = res.data;
                    this.toString();
                })
