        ...
        <div class="container">
            ...
            >
                <el-table-column type="selection" width="55" align="center"></el-table-column>
                    ...
                    <el-table-column prop="equip_no" label="设备编号"></el-table-column>
                    <el-table-column prop="equip_type" label="设备类型"></el-table-column>
                    <el-table-column prop="equip_loc" label="所处产线"></el-table-column>
                    <el-table-column prop="fault_desc" label="故障描述"></el-table-column>
                    <el-table-column prop="status" label="状态"></el-table-column>
                    <el-table-column prop="report_person" label="上报人姓名"></el-table-column>
                    <el-table-column prop="assign_time" label="指派时间"></el-table-column>
                    <el-table-column prop="maintenance_worker" label="维修工人"></el-table-column>
