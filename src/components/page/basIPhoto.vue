    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="iphotodistance" label="感应距离"></el-table-column>
                <el-table-column prop="iphotoway" label="感应方式"></el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="95px">
                ...
                <el-form-item label="感应距离"><el-input v-model="form.iphotodistance"></el-input></el-form-item>
                <el-form-item label="感应方式"><el-input v-model="form.iphotoway"></el-input></el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                this.$axios.get('/api/basIphoto/selectAll').then(res =>{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.$axios.get('/api/basIphoto/delete?id='+row.id).then(res=>{
            ...
            saveEdit() {
                ...
                this.$axios.post('/api/basIphoto/edit',this.form).then(res=>{
            ...
            saveAdd() {
                ...
                this.$axios.post('/api/basIphoto/add',this.form).then(res=>{
            ...
            // 触发搜索按钮
            handleSearch() {
                this.$axios.get('/api/basIphoto/select?type='+this.query.address1+'&spec='+this.query.address2+'&id='+this.query.code).then(res =>{
                    this.tableData = res.data;
                    this.toString();
                })
