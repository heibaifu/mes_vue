    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 异常工序检测
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="95px">
                <el-form-item label="工序编码"><el-input v-model="form.procode"></el-input></el-form-item>
                <el-form-item label="工序名称"><el-input v-model="form.proname"></el-input></el-form-item>
                <el-form-item label="工序描述"><el-input v-model="form.prodesc"></el-input></el-form-item>
            </el-form>
...
<script>
    export default {
        ...
        methods: {
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$axios.get('/api/qcAbnormalProcess/selectAll').then(res =>{
                    this.tableData = res.data;
                })
            },
            // 触发搜索按钮
            handleSearch() {
                this.$axios.get('/api/qcAbnormalProcess/selectByName?proname='+this.query.proname).then(res =>{
                    this.tableData = res.data;
                })
            },
            // 删除操作
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.$axios.get('/api/tecProcess/deleteById?id='+row.id).then(res=>{
            ...
            delAllSelection() {
                ...
                for (let i = 0; i < length; i++) {
                    ...
                    this.$axios.get('/api/tecProcess/deleteById?id='+this.multipleSelection[i].id).then(res=>{
                    })
                }
            ...
            saveEdit() {
                ...
                this.$axios.post('/api/tecProcess/edit',this.form).then(res=>{
            ...
            saveAdd() {
                ...
                this.$axios.post('/api/tecProcess/add',this.form).then(res=>{
