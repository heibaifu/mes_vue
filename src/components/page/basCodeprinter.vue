    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="typeString" label="设备类型Id"></el-table-column>
                <el-table-column prop="specString" label="设备规格Id"></el-table-column>
                ...
                <el-table-column prop="mode" label="打印模式"></el-table-column>
                ...
                <el-table-column prop="organization" label="所有权部分"></el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="95px">
                ...
                <el-form-item label="设备类型Id"><el-input v-model="form.type"></el-input></el-form-item>
                ...
                <el-form-item label="打印模式"><el-input v-model="form.mode"></el-input></el-form-item>
                <el-form-item label="分辨率"><el-input v-model="form.resolution"></el-input></el-form-item>
                ...
                <el-form-item label="所有权部分"><el-input v-model="form.organization"></el-input></el-form-item>
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                this.$axios.get('/api/basCodeprinter/selectAll').then(res => {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.$axios.get('/api/basCodeprinter/delete?id='+row.id).then(res=>{
            ...
            saveEdit() {
                ...
                this.$axios.post('/api/basCodeprinter/edit',this.form).then(res=>{
            ...
            saveAdd() {
                ...
                this.$axios.post('/api/basCodeprinter/add',this.form).then(res=>{
            ...
            // 触发搜索按钮
            handleSearch() {
                this.$axios.get('/api/basCodeprinter/select?type='+this.query.address1+'&spec='+this.query.address2+'&id='+this.query.code).then(res =>{
                    this.tableData = res.data;
                    this.toString();
                })
